---
layout: post
title: 'Паттерн ООП Command'
category: python
---

Decouple the objects that invokes the operation from the one that knows how to perform it.

<img src="/assets/img/2020-05-31-pattern-command/command.png">
